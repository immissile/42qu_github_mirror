...
from model.pic import Pic, pic_list_to_review_by_cid, pic_to_review_count_by_cid, pic_list_reviewed_by_cid_state, pic_yes, pic_no_total, pic_reviewed_count_by_cid_state
...
class Review(Base):
    ...
    def post(self, cid):
        ...
        for i in ids_no:
            pic_no_total(i, current_user_id)
