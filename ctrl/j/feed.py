...
class FeedPic(JLoginBase):
    def get(self):
        result = [[65 , 0 , 10002411 , '玛娜法鲁岛' ,'是休闲式度假村，拥有着马尔夫的传统，同时与朴素、高雅亚洲风情配合得天衣无缝。这个度假村让您在马尔代夫享受到宁静舒适的服务。' ,['p.realfex.xxx',191830 , 440, 658 ],[ 'realfex' ,10245025],[[10000001,'张沈鹏',10003201,'美得让人颤抖。。'],[10000002,'subdragen','不错不错，很好看，剩余的内容呢，还是算了。']],[[1000003,'金正日'],[10000004,'东方不败2000']]]]*20
        self.finish(dumps(result))
