$.template(
    ...
    '<div class="readl c">'+
        ...
        '<div id="reado${$data[0]}" class="reado"><span class="reada"><span class="title">${$data[1]}</span><span class="rtip">${$data[2]}</span></span></div><div class="zname"><a href="#" rel="${$data[3]}" class="TPH" target="_blank">${$data[4]}</a></div></div>'
)
