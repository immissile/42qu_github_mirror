...
(function() {
	...
	function _(a, b, id, v) {
        ...
        fancybox({
            content:'<form id="vote_reply" class="fancyreply"><h3>理由如下 ...</h3><textarea name="txt"></textarea><div class="btns"><span class="btnw"><button class="btn" type="submit">表态</button></span></div></form>',
            onComplete:function(){
