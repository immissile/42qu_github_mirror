...
function share(id) {
	...
	fancybox({
		content: '<form id="vote_reply" class="fancyreply"><h3>推荐语</h3><textarea name="txt"></textarea><input type="checkbox" name="sync" class="sync"/><div class="btns"><span class="rec_tip share_sync">142字以内</span><span class="btnw"><button class="btn" type="submit">分享</button></span></div></form>',
		onComplete: function() {
