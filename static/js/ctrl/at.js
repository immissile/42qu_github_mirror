...
methods={
    ...
    deleteRangeText: function (t, n) {
        var p = this.getCursorPosition(t[0]),
            s = t.scrollTop,
            val = t.val()

        // reset value  
         t.val(val.slice(0,p-n))
        // reset cursor
...
$.fn.pop_at = function(){
    ...
    this.bind('keyup',function(e){
        at_list,at_size
        var self = $(this)
        offset = methods.getCursorPosition(self)
        var val = self.val()
        ...
        if(lastCharAt>=0 && hasSpace<0){
            ...
            if($.inArray(e.keyCode,keys)<0){
                ...
                $('.at_li').click(function(){atComplete(self,wordsForSearch)})
        ...
        switch (e.keyCode) {
            ...
            case 13:
            e.preventDefault();
            atComplete($(this),wordsForSearch)
            break;
