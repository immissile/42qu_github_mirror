...
from model.privilege import PRIVILEGE_FEED_IMPORT
...
LOG_HISTORY_CID_PRIVILEGE_FEED_IMPORT = 6
...
LOG_HISTORY_CID = (
    ...
    LOG_HISTORY_CID_PRIVILEGE_FEED_IMPORT
)
LOG_HISTORY_CN_CID = {
    ...
    LOG_HISTORY_CID_PRIVILEGE_FEED_IMPORT:PRIVILEGE_CN[PRIVILEGE_FEED_IMPORT],
}

LOG_PART_TIME_MAPPING = {
    PRIVILEGE_FEED_IMPORT:LOG_HISTORY_CID_PRIVILEGE_FEED_IMPORT,
    }
