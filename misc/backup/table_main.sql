...
) ENGINE=MyISAM AUTO_INCREMENT=762 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=764 DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_mail` (
  ...
  KEY `mail` (`mail`)
) ENGINE=MyISAM AUTO_INCREMENT=24207 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_password` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10024795 DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
