...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `buy_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `buy_address` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `user_id` int(10) unsigned NOT NULL,
  `receiver` varbinary(255) NOT NULL,
  `pid` int(10) unsigned NOT NULL,
  `address` varbinary(255) NOT NULL,
  `zipcode` varbinary(16) NOT NULL,
  `phone_list` blob NOT NULL,
...
CREATE TABLE `job_type` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `Index_2` USING BTREE (`job_id`,`type_id`),
  KEY `Index_3` (`type_id`)
) ENGINE=MyISAM DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log_history` (
  ...
  `user_id` int(10) unsigned NOT NULL,
  PRIMARY KEY  (`id`),
  UNIQUE KEY `Index_2` USING BTREE (`cid`,`day`,`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `oauth_token_google`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oauth_token_google` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `pic_wall_pics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pic_wall_pics` (
  `id` int(11) NOT NULL auto_increment,
  `url` blob NOT NULL,
  `title` varbinary(128) default NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `po_pic_pos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `po_pic_pos` (
  `id` int(11) NOT NULL,
  `value` int(11) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `po_pic_show`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `po_pic_show` (
  `id` int(11) NOT NULL auto_increment,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `site_rec_new`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `site_rec_new` (
  `id` int(11) unsigned NOT NULL,
  `value` blob NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=binary COMMENT='temporary for testing';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `starer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `starer` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `price_min` int(10) unsigned NOT NULL,
  `price_now` int(10) unsigned NOT NULL,
  `end_time` int(10) unsigned NOT NULL,
  `buy_count` int(10) unsigned NOT NULL,
  `state` tinyint(3) unsigned NOT NULL,
  `begin_time` int(10) unsigned NOT NULL,
  PRIMARY KEY  (`id`),
  KEY `Index_2` (`state`),
  KEY `Index_3` (`end_time`)
) ENGINE=MyISAM DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `starter_buy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `starter_buy` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `user_id` int(10) unsigned NOT NULL,
  `starter_id` int(10) unsigned NOT NULL,
  `starter_sell_id` int(10) unsigned NOT NULL,
  `state` tinyint(3) unsigned NOT NULL,
  `time` int(10) unsigned NOT NULL,
  `buy_address_id` int(10) unsigned NOT NULL,
  PRIMARY KEY  (`id`),
  KEY `Index_2` (`starter_sell_id`),
  KEY `Index_3` (`starter_id`),
  KEY `Index_4` (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `starter_sell`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `starter_sell` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `price` int(10) unsigned NOT NULL,
  `buy_max` int(10) unsigned NOT NULL,
  `buy_now` int(10) unsigned NOT NULL,
  `txt` blob NOT NULL,
  `cid` tinyint(3) unsigned NOT NULL,
  `started_id` int(10) unsigned NOT NULL,
  PRIMARY KEY  (`id`),
  KEY `Index_2` (`started_id`)
) ENGINE=MyISAM DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `zsite_member_invite`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zsite_member_invite` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `zsite_id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  PRIMARY KEY  (`id`)
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `zsite_site_max`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zsite_site_max` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `zsite_id` int(10) unsigned NOT NULL,
  `max_id` int(10) unsigned NOT NULL default '0',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `Index_2` USING BTREE (`zsite_id`)
) ENGINE=InnoDB DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `zsite_site_pos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zsite_site_pos` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `user_id` int(10) unsigned NOT NULL,
  `zsite_id` int(10) unsigned NOT NULL,
  ...
  `cid` tinyint(3) unsigned NOT NULL,
  PRIMARY KEY  (`id`),
  UNIQUE KEY `Index_2` (`user_id`,`zsite_id`,`cid`)
) ENGINE=InnoDB DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `po_rid_meta` (
  ...
  `url_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `Index_2` (`user_id`,`url_id`) USING BTREE
...
CREATE TABLE `zsite_book` (
  ...
  `rating_num` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `Index_2` (`douban_id`) USING BTREE,
  KEY `Index_3` (`isbn`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `zsite_book_browse`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
...
CREATE TABLE `zsite_book_lib` (
  ...
  `pid` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `Index_2` (`owner_id`) USING BTREE,
  KEY `Index_3` (`state`,`book_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=binary;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `zsite_com`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
